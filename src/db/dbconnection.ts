...
import { AutorSchema, EditorialSchema, LibroSchema } from "./schema.ts";
...
export const editorialCollection = db.collection<EditorialSchema>("editoriales")

export const librosCollection = db.collection<LibroSchema>("libros")

export const autorCollection = db.collection<AutorSchema>("autores")